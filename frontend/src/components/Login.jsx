    ...
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center p-6 bg-[#D9EAFD]">
      ...
      <div className="bg-[#F8FAFC] shadow-lg p-6 rounded-lg w-full max-w-md md:w-1/2">
        ...
        <div className=" flex gap-2 justify-center p-2">
          ...
          <button className="relative text-lg hover:text-blue-600 transition-colors duration-300
                before:absolute before:left-0 before:-bottom-1 before:w-0 before:h-[2px] before:bg-green-300 before:transition-all before:duration-300
                hover:before:w-full hover:text-green-400 hover:cursor-pointer" onClick={createAcc}>Create Account</button>
        </div>
      </div>
    </div>
  );
